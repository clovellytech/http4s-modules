...
abstract class PermissionClientRunner[F[_]: Sync: Bracket[?[_], Throwable]]
  ...
  lazy val permissionEndpoints =
    new PermissionEndpoints[F, TSecBearerToken](SecuredRequestHandler(auth))
