package com.clovellytech.files.domain

import java.util.UUID

import org.scalacheck._
import cats.implicits._
import com.clovellytech.dbtesting.arbitraries.nonEmptyString
import com.clovellytech.files.infrastructure.endpoint.FileUpload
